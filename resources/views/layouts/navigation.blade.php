                    ...
                    <form id="ajax-logout-form-header" method="POST" action="{{ route('logout') }}" class="inline">
                        ...
                        <button type="button" onclick="handleLogout()" 
                            ...
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.022 1C7.022 1 2 4.418 2 10.5C2 16.582 7.022 20 7.022 20V1ZM22 10.5C22 4.418 16.978 1 16.978 1V20C16.978 20 22 16.582 22 10.5Z"></path>
                            </svg>
                            <span class="ml-2 hidden lg:inline">{{ __('Logout') }}</span>
                        </button>
                    </form>
                @endauth
